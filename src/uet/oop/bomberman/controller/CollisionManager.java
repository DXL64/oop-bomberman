...
import uet.oop.bomberman.entities.Hitbox;
...
public class CollisionManager {
    ...
    public Pair<Entity, Entity> checkCollision(int x, int y, DIRECTION direction) {
        ...
        switch (direction) {
            case LEFT:
                ...
                break;
            case RIGHT:
                object1 = map.getCoordinate(x + 24, y + FIX_HEIGHT);
                object2 = map.getCoordinate(x + 24, y + Sprite.SCALED_SIZE - FIX_HEIGHT);
                break;
            case UP:
                object1 = map.getCoordinate(x + FIX_WIDTH, y + FIX_HEIGHT);
    ...
    public boolean collide(Entity entity1, Entity entity2) {
        ...
        vertices.add(new Pair<Integer, Integer>(entity2.getX() + Sprite.SCALED_SIZE - FIX_WIDTH * 2, entity2.getY() + Sprite.SCALED_SIZE - FIX_HEIGHT * 2));
        vertices.add(new Pair<Integer, Integer>(entity2.getX() + Sprite.DEFAULT_SIZE, entity2.getY() + Sprite.DEFAULT_SIZE));
    ...
    public boolean collide(int xBomber, int yBomber, Entity entity) {
        ArrayList<Pair<Integer, Integer>> vertices = new ArrayList<>();
        // if (entity1 instanceof Bomber) {
        vertices.add(new Pair<Integer, Integer>(xBomber + Hitbox.FIX_HITBOX_BOMBER_X / 2, yBomber));
        vertices.add(new Pair<Integer, Integer>(xBomber + 24, yBomber));
        vertices.add(new Pair<Integer, Integer>(xBomber
                + Hitbox.FIX_HITBOX_BOMBER_X / 2, yBomber + Sprite.SCALED_SIZE));
        vertices.add(
    ...
    public boolean collide(Hitbox hitbox1, Hitbox hitbox2) {
        //System.out.println(hitbox1.collideWith(hitbox2));
        return hitbox1.collideWith(hitbox2);
    }
